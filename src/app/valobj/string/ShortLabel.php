...
class ShortLabel extends StringValueObjectAdapter {
	...
	public function __construct(string $value) {
		...
		IllegalValueException::assertTrue(ValidationUtils::maxlength($this->value, 31),
	...
	static function marshalMapper(): Mapper {
		return Mappers::valueClosure(fn (ShortLabel $name) => $name->toScalar());
	}
